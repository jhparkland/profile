...
(function () {
    ...
    function w(a) {
        ...
        this.l = -1;
        this.h.style.cssText = "max-width:none;display:inline-block;position:absolute;height:100%;width:100%;o" +
                "verflow:scroll;font-size:16px;";
        this.i.style.cssText = "max-width:none;display:inline-block;position:absolute;height:100%;width:100%;o" +
                "verflow:scroll;font-size:16px;";
        this.j.style.cssText = "max-width:none;display:inline-block;position:absolute;height:100%;width:100%;o" +
                "verflow:scroll;font-size:16px;";
    ...
    function x(a, c) {
        a.g.style.cssText = "max-width:none;min-width:20px;min-height:20px;display:inline-block;overflow:hi" +
                "dden;position:absolute;width:auto;margin:0;padding:0;top:-999px;white-space:no" +
                "wrap;font-synthesis:none;font:" + c + ";"
    }
    function B(a) {
