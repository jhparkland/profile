document.addEventListener('DOMContentLoaded', function () {
    ...
    setInterval(function () {
        ...
        Array
            .from(tocBorad.querySelectorAll('.toc-link'))
            .forEach(function (link) {
                link
                    .classList
                    .remove('is-active-link');
            });
    ...
    // Move to Comment
    document
        .getElementById('comments-counter')
        .addEventListener('click', function () {
            document
                .getElementById("giscus")
    ...
    if (currentTheme === 'dark') {
        ...
        Array
            .from(innerContent.querySelectorAll('pre'))
...
window.addEventListener('load', function () {
    ...
    if (pageHits) {
        ...
        const requestURL = 'https://' + goatcounterCode + '.goatcounter.com/counter/' +
    ...
    document
        .querySelectorAll('.language-text, .language-plaintext')
        .forEach(function (codeblock) {
            codeblock
                .querySelectorAll('.hljs-keyword, .hljs-meta, .hljs-selector-tag')
                .forEach(function ($) {
                    $.outerHTML = $.innerHTML;
                });
        });
    ...
    const giscus_repo = document
        .querySelector('meta[name="giscus_repo"]')
        .content;
    const giscus_repoId = document
        .querySelector('meta[name="giscus_repoId"]')
        .content;
    const giscus_category = document
        .querySelector('meta[name="giscus_category"]')
        .content;
    const giscus_categoryId = document
        .querySelector(
            'meta[name="giscus_categoryId"]'
        )
        .content;
